...
class Sauerbraten(ConanFile):
    ...
    def requirements(self):
        ...
        self.requires("sdl/[>=2.32 <3]", force=True)
        self.requires("sdl_image/[>=2.8 <3]", force=True)
        self.requires("sdl_mixer/[>=2.8 <3]", force=True)
        self.requires("zlib/[>=1.3.1 <1.4]", force=True)
